            ...
            if (state is Sign) {
                ...
                if (ChatColor.stripColor(sign.getLine(0))?.equals("[크레딧]", ignoreCase = true) == true) {
                    ...
                    for(player in Bukkit.getOnlinePlayers()) {
                        ...
                        val credit = listOf(
                            "${ChatColor.of("#FF0000")}[팀장]" to "${ChatColor.YELLOW}낑깡",
                            "${ChatColor.of("#EA9999")}[부팀장]" to "${ChatColor.YELLOW}해빛",
                            "${ChatColor.of("#d5a6bd")}[서버장 & 플러그인 제작자]" to "${ChatColor.YELLOW}하이네",
                            "${ChatColor.of("#d5a6bd")}[서버장 & 플러그인 제작자]" to "${ChatColor.YELLOW}리온",
                            "${ChatColor.of("#b4a7d6")}[건축팀장]" to "${ChatColor.YELLOW}한서",
                            "${ChatColor.of("#b4a7d6")}[건축가]" to "${ChatColor.YELLOW}유네아",
                            "${ChatColor.of("#b4a7d6")}[건축가]" to "${ChatColor.YELLOW}소울투이",
                            "${ChatColor.of("#b4a7d6")}[건축가]" to "${ChatColor.YELLOW}라스",
                            "${ChatColor.of("#6aa84f")}[스킨]" to "${ChatColor.YELLOW}워커",
                            "${ChatColor.of("#d9d9d9")}[커맨드]" to "${ChatColor.YELLOW}은성",
                            "${ChatColor.of("#9fc5e8")}[스토리보드]" to "${ChatColor.YELLOW}고안브",
                            "${ChatColor.of("#6d9eeb")}[영상 편집자]" to "${ChatColor.YELLOW}김행주",
                            "${ChatColor.of("#76a5af")}[목소리 연기]" to "${ChatColor.YELLOW}노운",
                            "${ChatColor.of("#76a5af")}[목소리 연기]" to "${ChatColor.YELLOW}LADDER",
                            "${ChatColor.of("#76a5af")}[목소리 연기]" to "${ChatColor.YELLOW}류설기",
                            "${ChatColor.of("#00ff00")}[로고 & 룰북]" to "${ChatColor.YELLOW}요1비",
                            "${ChatColor.of("#f9cb9c")}[기획]" to "${ChatColor.YELLOW}공도리",
                            "${ChatColor.of("#f9cb9c")}[기획]" to "${ChatColor.YELLOW}뭉개구름이",
