    ...
    private fun setupMessageFile() {
        ...
        if (!file.exists()) {
            ...
            file.writeText("""
                ...
                §e조합은 인벤토리를열어 조합아이템을 클릭하면 조합창이열리며 리스트에 있는 아이템에 맞게 넣으실경우 조합을 하실수 있습니다. \n조합법을 설명으로 보시려면 §a/조합법 §e명령어를 사용하여 주시기 바랍니다.
                §e해당 게임에는 부활시스템이 존재합니다.\n첫 사망시 시체가 남으며 시체위에는 부활이라는 메세지가 떠있게됩니다.\n다른사람이 본인의 시체위에서 §a웅크리고§e있을경우 §b부활§e을 시켜줄수 있으며. \n시체의 아이템을 §a모두 회수§e하여 가져갈경우 시체의주인은 부활이 금지되며 즉시 사망하게됩니다.\n\n
        ...
        if(!items.exists()){
            ...
            items.writeText("""
                ...
                §e지도 §b-> §a주위 §b50블럭§ 이내의 사람에게 발광효과를 부여합니다.
