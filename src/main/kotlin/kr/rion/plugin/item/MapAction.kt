...
// 가장 가까운 플레이어 처리
        if (nearestPlayer != null) {
            ...
            player.sendMessage("$prefix ${ChatColor.GOLD}발광 효과를 부여할 플레이어가 없습니다.")
        }
