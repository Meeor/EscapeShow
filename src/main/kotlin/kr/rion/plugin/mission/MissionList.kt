...
object MissionList {
    ...
    fun registerAll() {
        ...
        MissionRegistry.registerMission(17, CraftingMission(listOf(Material.IRON_CHESTPLATE to 1))) //inventoryClickEvent
        MissionRegistry.registerMission(18, CraftingMission(listOf(Material.DIAMOND_CHESTPLATE to 1))) //inventoryClickEvent
        ...
        MissionRegistry.registerMission(23, ItemUsageMission(Material.SKULL_BANNER_PATTERN, "contract", 1, Loader.instance)) //PlayerInteractEvent
        MissionRegistry.registerMission(24, ItemUsageMission(Material.MOJANG_BANNER_PATTERN, "map", 3, Loader.instance)) //PlayerInteractEvent
        MissionRegistry.registerMission(25, ItemUsageMission(Material.NETHER_BRICK, "gips", 1, Loader.instance)) //PlayerInteractEvent
        MissionRegistry.registerMission(26, ItemUsageMission(Material.PAPER, "heal", 10, Loader.instance)) //PlayerInteractEvent
        MissionRegistry.registerMission(27, ItemUsageMission(Material.PAPER, "heal", 15, Loader.instance)) //PlayerInteractEvent
        MissionRegistry.registerMission(28, ItemUsageMission(Material.PAPER, "heal", 20, Loader.instance)) //PlayerInteractEvent
